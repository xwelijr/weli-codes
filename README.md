...
- Project screenshots live in `public/assets/`. Projects without a real screenshot (RKS test environment, ManageEngine USB control) are deliberately text-only — never give them a decorative/AI-looking graphic.
